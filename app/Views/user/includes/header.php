...
<head>
    ...
    <link rel="stylesheet" href="<?= USER_PATH ?>/css/bootstrap.min.css" />
    <link rel="stylesheet" href="<?= USER_PATH ?>/css/style.css" />
    <link rel="stylesheet" href="<?= USER_PATH ?>/css/main.css" />
    <link rel="stylesheet" href="<?= USER_PATH ?>/css/account.css" />
                        ...
                        <li class="account">
                            <a href="#" class="dropdown-toggle" id="accountDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                ...
                                <?php if (!empty($item['anh'])) : ?>
                                    <img src="<?= USER_PATH ?>/icon/<?= $item['anh'] ?>" alt="user" width="30px" height="30px">
                                <?php else : ?>
